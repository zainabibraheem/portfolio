        ...
        <div className='bg-black px-7 lg:px-9 pb-12 ' id='about'>
            ...
            <div className=' flex flex-col lg:flex-row gap-10 '>
                <div className='text-complex leading-7 flex flex-col gap-6 mt-3 lg:gap-10 lg:w-3/5'>
                    <p>Hey there! {" "} I'm  <span className='text-main'>Zainab</span>, a <span className='text-main'>frontend developer</span> with a keen eye for design. I love building quality, virtually appealing web applications using javacritp and its frasmeworks. I am very passionate about building user friendly interfaces. I write clean, functional code and also love collaborating with colleagues to achieve project success. </p>
                    <p>I also write informative articles on various technical topics, educating users and fellow developers with my <span className='text-main'>blog</span> post. </p>
                    <p>If you're looking for a passionate <span className='text-main'>Frontend Developer</span> and <span className='text-main'>Technical Writer</span> to bring your ideas to life, i'm your girl.</p>
                    <a href='#contact' >
